...
export BINDER_DESIGNER_DIR="/home/valkove2/soft/binder_designer"
export RFDIFFUSION_DIR="/home/valkove2/soft/RFdiffusion"
export DL_BINDER_DESIGN_DIR="/home/valkove2/soft/dl_binder_design"
export SILENT_TOOLS_DIR="/home/valkove2/soft/silent_tools"
export PROTEINMPNN_DIR="/home/valkove2/soft/ProteinMPNN"
...
if [ -f "$PARAMS_FILE" ]; then
	...
	partial_diff=$(grep 'diffuser.partial_T=' $PARAMS_FILE | cut -d'=' -f2)
	...
	# Construct the command with values extracted from parameters file
	    ...
	    'diffuser.partial_T=$partial_diff'"
